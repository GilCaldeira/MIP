...
export default class TravelPlanService {
  ...
  public create(entity: ITravelPlan): Promise<ITravelPlan> {
    return new Promise<ITravelPlan>((resolve, reject) => {
      axios
  ...
  public update(entity: ITravelPlan): Promise<ITravelPlan> {
    return new Promise<ITravelPlan>((resolve, reject) => {
      axios
  ...
  public partialUpdate(entity: ITravelPlan): Promise<ITravelPlan> {
    return new Promise<ITravelPlan>((resolve, reject) => {
      axios
