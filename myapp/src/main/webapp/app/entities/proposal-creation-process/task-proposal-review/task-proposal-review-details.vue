  ...
  <div class="row justify-content-center">
    <div class="col-10">
      <h2 id="page-heading" data-cy="TaskInstanceHeading">
        <span v-text="$t('myappApp.taskInstance.details.title')" id="task-instance-heading">Task Details</span>
      </h2>
      <div v-if="taskContext.taskInstance">
        <akip-show-task-instance :taskInstance="taskContext.taskInstance">
          <template v-slot:body>
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('myappApp.taskProposalReview.name')">name</label>
              <input
                readonly
                type="text"
                class="form-control"
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('myappApp.taskProposalReview.travelName')">travelName</label>
              <input
                readonly
                type="text"
                class="form-control"
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('myappApp.taskProposalReview.customerName')">customerName</label>
              <input
                readonly
                type="text"
                class="form-control"
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('myappApp.taskProposalReview.travelStartDate')">travelStartDate</label>
              <input
                readonly
                type="text"
                class="form-control"
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('myappApp.taskProposalReview.travelEndDate')">travelEndDate</label>
              <input
                readonly
                type="text"
                class="form-control"
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('myappApp.taskProposalReview.travelType')">travelType</label>
              <input
                readonly
                type="text"
                class="form-control"
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('myappApp.taskProposalReview.examplesOtherTravelServices')"
            ...
            <div class="form-group">
              <label
                ...
                v-text="$t('myappApp.taskProposalReview.airlineCompany')"
                for="task-proposal-review-airlineCompany"
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('myappApp.taskProposalReview.hotel')" for="task-proposal-review-hotel"
                >Hotel</label
              >
              <input
        ...
        <router-link
          ...
          :to="`/process-definition/ProposalCreationProcess/task/ProposalReview/${taskContext.taskInstance.id}/execute`"
          tag="button"
...
<script lang="ts" src="./task-proposal-review-details.component.ts"></script>
